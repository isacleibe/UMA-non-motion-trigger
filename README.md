...
1. 74HC244 --> En la [hoja de características del sn74hc244](http://www.ti.com/lit/ds/symlink/sn74hc244.pdf) aparecen en el apartado 6.3 las características que debe cumplir la señal de entrada. Entre ellas se encuentra el tiempo de subida y bajada : Para la alimentación (de 5V) se encuentra sobre los ``500nS/V`` lo que imposibilita tener como entrada la respuesta de un circuito RC.
Como solución a este problema se decide usar un operacional con configuración Trigger-Schmitt.
...
**NOTA: Pendiente por actualizar esquematicos y revisar simulaciones**